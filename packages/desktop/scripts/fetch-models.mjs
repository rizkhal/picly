 ...
 * those two files, and writes them to the monorepo root models/buffalo_l/ — the
 * shared model dir both desktop and mobile consume. electron-builder copies it
 * into the app via extraResources (Contents/Resources/models). The models are
