...
contextBridge.exposeInMainWorld('electron', {
  ...
  local: {
    ...
    cleanupStats: () => ipcRenderer.invoke('local:cleanup-stats'),
    cleanupUnassignedFaces: () => ipcRenderer.invoke('local:cleanup-unassigned-faces'),
    cleanupLowQualityFaces: () => ipcRenderer.invoke('local:cleanup-low-quality-faces'),
    ...
    isDirectory: (p) => ipcRenderer.invoke('local:is-dir', p),
