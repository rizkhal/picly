 ...
 * required args — model paths resolve from ~/.insightface or PICLY_MODELS_DIR),
 * so local.ts / scanner.ts / scripts/*.cjs are untouched.
 */
 ...
 * modelsDir override (default ~/.insightface or PICLY_MODELS_DIR). */
